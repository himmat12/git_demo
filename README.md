# Git Demo
A demo repo for github and git commands.
...
### Cloning the repo
 ...
 - Then run `git clone https://github.com/<repo name>` command to clone our repo from github.
 - Once this cmdlet finsh running check you dir you should have `<repo name>` dir on your specified file location. 
